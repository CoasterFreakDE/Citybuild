...
public class ArgumentUtils {
    ...
    private static <A extends ArgumentType<?>, T extends ArgumentTypeInfo.Template<A>> void serializeCap(JsonObject json, ArgumentTypeInfo<A, T> serializer, ArgumentTypeInfo.Template<A> properties) {
    ...
    private static <T extends ArgumentType<?>> void serializeArgumentToJson(JsonObject json, T argumentType) {
        ...
        json.addProperty("parser", Registry.COMMAND_ARGUMENT_TYPE.getKey(template.type()).toString());
