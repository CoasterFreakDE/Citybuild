...
public class SuggestionProviders {
    ...
    public static <S extends SharedSuggestionProvider> SuggestionProvider<S> register(ResourceLocation id, SuggestionProvider<SharedSuggestionProvider> provider) {
