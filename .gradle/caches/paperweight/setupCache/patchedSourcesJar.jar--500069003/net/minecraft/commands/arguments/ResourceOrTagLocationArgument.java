...
public class ResourceOrTagLocationArgument<T> implements ArgumentType<ResourceOrTagLocationArgument.Result<T>> {
    ...
    public static <T> ResourceOrTagLocationArgument.Result<T> getRegistryType(CommandContext<CommandSourceStack> context, String name, ResourceKey<Registry<T>> registryRef, DynamicCommandExceptionType invalidException) throws CommandSyntaxException {
    ...
    public static class Info<T> implements ArgumentTypeInfo<ResourceOrTagLocationArgument<T>, ResourceOrTagLocationArgument.Info<T>.Template> {
        @Override
        public void serializeToNetwork(ResourceOrTagLocationArgument.Info<T>.Template properties, FriendlyByteBuf buf) {
        ...
        @Override
        public void serializeToJson(ResourceOrTagLocationArgument.Info<T>.Template properties, JsonObject json) {
            json.addProperty("registry", properties.registryKey.location().toString());
        }

        @Override
        public ResourceOrTagLocationArgument.Info<T>.Template unpack(ResourceOrTagLocationArgument<T> argumentType) {
            return new ResourceOrTagLocationArgument.Info.Template(argumentType.registryKey);
        }
