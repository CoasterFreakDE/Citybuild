...
public class SoundEvents {
    ...
    private static SoundEvent register(String id, float distanceToTravel) {
        return Registry.register(Registry.SOUND_EVENT, id, new SoundEvent(new ResourceLocation(id), distanceToTravel));
    }
    ...
    private static ImmutableList<SoundEvent> registerGoatHornSoundVariants() {
        return IntStream.range(0, 8).mapToObj((variant) -> {
            return register("item.goat_horn.sound." + variant);
