...
public abstract class Registry<T> implements Keyable, IdMap<T> {
    ...
    public static final Registry<IntProviderType<?>> INT_PROVIDER_TYPES = registerSimple(INT_PROVIDER_TYPE_REGISTRY, (registry) -> {
    ...
    public static final Registry<StructureType<?>> STRUCTURE_TYPES = registerSimple(STRUCTURE_TYPE_REGISTRY, (registry) -> {
    ...
    public static final Registry<RootPlacerType<?>> ROOT_PLACER_TYPES = registerSimple(ROOT_PLACER_TYPE_REGISTRY, (registry) -> {
    ...
    public static final Registry<Codec<? extends ChunkGenerator>> CHUNK_GENERATOR = registerSimple(CHUNK_GENERATOR_REGISTRY, Lifecycle.stable(), ChunkGenerators::bootstrap);
    ...
    public static final Registry<CatVariant> CAT_VARIANT = registerSimple(CAT_VARIANT_REGISTRY, (registry) -> {
    ...
    public static final Registry<FrogVariant> FROG_VARIANT = registerSimple(FROG_VARIANT_REGISTRY, (registry) -> {
    ...
    public abstract Optional<Holder<T>> getRandom(RandomSource random);
    ...
    public abstract Holder<T> getOrCreateHolderOrThrow(ResourceKey<T> key);

    public abstract DataResult<Holder<T>> getOrCreateHolder(ResourceKey<T> key);
