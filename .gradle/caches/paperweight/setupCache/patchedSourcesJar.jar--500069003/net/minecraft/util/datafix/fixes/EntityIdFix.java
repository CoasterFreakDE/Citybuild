...
public class EntityIdFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        TaggedChoice.TaggedChoiceType<String> taggedChoiceType = this.getInputSchema().findChoiceType(References.ENTITY);
        TaggedChoice.TaggedChoiceType<String> taggedChoiceType2 = this.getOutputSchema().findChoiceType(References.ENTITY);
