...
public interface ToFloatFunction<C> {
    ToFloatFunction<Float> IDENTITY = createUnlimited((value) -> {
        return value;
    });
    ...
    static ToFloatFunction<Float> createUnlimited(final Float2FloatFunction delegate) {
    ...
    default <C2> ToFloatFunction<C2> comap(final Function<C2, C> before) {
