...
public class BlockEntityIdFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        TaggedChoice.TaggedChoiceType<String> taggedChoiceType = this.getInputSchema().findChoiceType(References.BLOCK_ENTITY);
        TaggedChoice.TaggedChoiceType<String> taggedChoiceType2 = this.getOutputSchema().findChoiceType(References.BLOCK_ENTITY);
