...
public class GsonHelper {
    ...
    @Nullable
    public static <T> T fromJson(Gson gson, String content, Class<T> clazz, boolean lenient) {
        return fromJson(gson, new StringReader(content), clazz, lenient);
    }
    ...
    @Nullable
    public static <T> T fromJson(Gson gson, String content, Class<T> clazz) {
        return fromJson(gson, content, clazz, false);
    }
    ...
    public static void writeValue(JsonWriter writer, @Nullable JsonElement json, @Nullable Comparator<String> comparator) throws IOException {
        if (json != null && !json.isJsonNull()) {
            if (json.isJsonPrimitive()) {
                ...
                for(Map.Entry<String, JsonElement> entry : sortByKeyIfNeeded(json.getAsJsonObject().entrySet(), comparator)) {
