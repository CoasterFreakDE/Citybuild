...
public class DataPackCommand {
    ...
    private static int listAvailablePacks(CommandSourceStack source) {
        ...
        if (list.isEmpty()) {
            ...
            source.sendSuccess(Component.translatable("commands.datapack.list.available.success", list.size(), ComponentUtils.formatList(list, (profile) -> {
    ...
    private static int listEnabledPacks(CommandSourceStack source) {
        ...
        if (collection.isEmpty()) {
            ...
            source.sendSuccess(Component.translatable("commands.datapack.list.enabled.success", collection.size(), ComponentUtils.formatList(collection, (profile) -> {
