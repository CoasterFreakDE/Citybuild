...
public class SimpleReloadInstance<S> implements ReloadInstance {
    ...
    protected SimpleReloadInstance(Executor prepareExecutor, final Executor applyExecutor, ResourceManager manager, List<PreparableReloadListener> reloaders, SimpleReloadInstance.StateFactory<S> factory, CompletableFuture<Unit> initialStage) {
