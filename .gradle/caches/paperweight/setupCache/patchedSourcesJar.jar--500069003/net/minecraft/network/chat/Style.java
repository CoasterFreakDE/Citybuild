...
public class Style {
    ...
    public static final Codec<Style> FORMATTING_CODEC = RecordCodecBuilder.create((instance) -> {
        ...
        }), ResourceLocation.CODEC.optionalFieldOf("font").forGetter((style) -> {
    ...
    private static Style create(Optional<TextColor> color, Optional<Boolean> bold, Optional<Boolean> italic, Optional<Boolean> underlined, Optional<Boolean> strikethrough, Optional<Boolean> obfuscated, Optional<String> insertion, Optional<ResourceLocation> font) {
        return new Style(color.orElse((TextColor)null), bold.orElse((Boolean)null), italic.orElse((Boolean)null), underlined.orElse((Boolean)null), strikethrough.orElse((Boolean)null), obfuscated.orElse((Boolean)null), (ClickEvent)null, (HoverEvent)null, insertion.orElse((String)null), font.orElse((ResourceLocation)null));
    }
