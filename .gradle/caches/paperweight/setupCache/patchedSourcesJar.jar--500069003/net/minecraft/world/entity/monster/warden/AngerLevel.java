...
public enum AngerLevel {
    ...
    private static final AngerLevel[] SORTED_LEVELS = Util.make(values(), (values) -> {
        Arrays.sort(values, (a, b) -> {
            return Integer.compare(b.minimumAnger, a.minimumAnger);
        });
    });
    ...
    private AngerLevel(int threshold, SoundEvent sound, SoundEvent listeningSound) {
