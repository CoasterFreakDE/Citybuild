...
public class GameEvent {
    ...
    public static record Context(@Nullable Entity sourceEntity, @Nullable BlockState affectedState) {
        ...
        public static GameEvent.Context of(@Nullable BlockState affectedState) {
            return new GameEvent.Context((Entity)null, affectedState);
        }
    ...
    public static final class Message implements Comparable<GameEvent.Message> {
        ...
        public Message(GameEvent event, Vec3 emitterPos, GameEvent.Context emitter, GameEventListener listener, Vec3 listenerPos) {
