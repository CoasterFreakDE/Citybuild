...
public class WoodlandMansionPieces {
    public static void generateMansion(StructureTemplateManager manager, BlockPos pos, Rotation rotation, List<WoodlandMansionPieces.WoodlandMansionPiece> pieces, RandomSource random) {
    ...
    static class MansionGrid {
        ...
        public boolean isRoomId(WoodlandMansionPieces.SimpleGrid layout, int i, int j, int floor, int roomId) {
            return (this.floorRooms[floor].get(i, j) & '\uffff') == roomId;
        }
            ...
            if (length > 0) {
                ...
                for(int k = 0; k < 8; ++k) {
                    ...
                    if (direction2 != direction.getOpposite() && (direction2 != Direction.EAST || !this.random.nextBoolean())) {
                        ...
                        if (layout.get(l + direction2.getStepX(), m + direction2.getStepZ()) == 0 && layout.get(l + direction2.getStepX() * 2, m + direction2.getStepZ() * 2) == 0) {
    ...
    static class MansionPiecePlacer {
                ...
                for(int n = 0; n < simpleGrid4.height; ++n) {
                    for(int o = 0; o < simpleGrid4.width; ++o) {
                        if (simpleGrid4.get(o, n) == 1) {
                            ...
                            if (simpleGrid4.get(o, n + 1) == 1 || (simpleGrid3.get(o, n + 1) & 8388608) == 8388608) {
                                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, string, blockPos2.relative(rotation.rotate(Direction.SOUTH), 5).relative(rotation.rotate(Direction.WEST), 1), rotation));
                            }

                            if (simpleGrid4.get(o - 1, n) == 1 || (simpleGrid3.get(o - 1, n) & 8388608) == 8388608) {
                                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, string2, blockPos2.relative(rotation.rotate(Direction.WEST), 1).relative(rotation.rotate(Direction.NORTH), 1), rotation));
                            }
                        }
                    }
                }
                    ...
                    for(int q = 0; q < simpleGrid4.width; ++q) {
                        ...
                        if (simpleGrid4.get(q, p) == 2 || bl2) {
                            ...
                            if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid4, q - 1, p) && !parameters.isRoomId(simpleGrid4, q - 1, p, m, t)) {
                                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, direction2 == Direction.WEST ? string4 : string3, blockPos3, rotation));
                            }

                            if (simpleGrid4.get(q + 1, p) == 1 && !bl2) {
                                BlockPos blockPos4 = blockPos3.relative(rotation.rotate(Direction.EAST), 8);
                                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, direction2 == Direction.EAST ? string4 : string3, blockPos4, rotation));
                            }
                            ...
                            if (WoodlandMansionPieces.MansionGrid.isHouse(simpleGrid4, q, p + 1) && !parameters.isRoomId(simpleGrid4, q, p + 1, m, t)) {
                                ...
                                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, direction2 == Direction.SOUTH ? string4 : string3, blockPos5, rotation.getRotated(Rotation.CLOCKWISE_90)));
                            }
                            ...
                            if (simpleGrid4.get(q, p - 1) == 1 && !bl2) {
                                ...
                                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, direction2 == Direction.NORTH ? string4 : string3, blockPos6, rotation.getRotated(Rotation.CLOCKWISE_90)));
                            }
        ...
        private void traverseOuterWalls(List<WoodlandMansionPieces.WoodlandMansionPiece> pieces, WoodlandMansionPieces.PlacementData wallPiece, WoodlandMansionPieces.SimpleGrid layout, Direction direction, int startI, int startJ, int endI, int endJ) {
            int i = startI;
            int j = startJ;
            ...
            do {
                ...
                } else if (WoodlandMansionPieces.MansionGrid.isHouse(layout, i + direction.getStepX(), j + direction.getStepZ()) && WoodlandMansionPieces.MansionGrid.isHouse(layout, i + direction.getStepX() + direction.getCounterClockWise().getStepX(), j + direction.getStepZ() + direction.getCounterClockWise().getStepZ())) {
        ...
        private void entrance(List<WoodlandMansionPieces.WoodlandMansionPiece> pieces, WoodlandMansionPieces.PlacementData wallPiece) {
            ...
            pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "entrance", wallPiece.position.relative(direction, 9), wallPiece.rotation));
        ...
        private void traverseWallPiece(List<WoodlandMansionPieces.WoodlandMansionPiece> pieces, WoodlandMansionPieces.PlacementData wallPiece) {
            pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, wallPiece.wallType, wallPiece.position.relative(wallPiece.rotation.rotate(Direction.EAST), 7), wallPiece.rotation));
        ...
        private void addRoom1x1(List<WoodlandMansionPieces.WoodlandMansionPiece> pieces, BlockPos pos, Rotation rotation, Direction direction, WoodlandMansionPieces.FloorRoomCollection pool) {
        ...
        private void addRoom1x2(List<WoodlandMansionPieces.WoodlandMansionPiece> pieces, BlockPos pos, Rotation rotation, Direction connectedRoomDirection, Direction entranceDirection, WoodlandMansionPieces.FloorRoomCollection pool, boolean staircase) {
            if (entranceDirection == Direction.EAST && connectedRoomDirection == Direction.SOUTH) {
                ...
                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get1x2SideEntrance(this.random, staircase), blockPos, rotation));
                ...
                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get1x2SideEntrance(this.random, staircase), blockPos2, rotation, Mirror.LEFT_RIGHT));
                ...
                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get1x2SideEntrance(this.random, staircase), blockPos3, rotation.getRotated(Rotation.CLOCKWISE_180)));
                ...
                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get1x2SideEntrance(this.random, staircase), blockPos4, rotation, Mirror.FRONT_BACK));
                ...
                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get1x2SideEntrance(this.random, staircase), blockPos5, rotation.getRotated(Rotation.CLOCKWISE_90), Mirror.LEFT_RIGHT));
                ...
                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get1x2SideEntrance(this.random, staircase), blockPos6, rotation.getRotated(Rotation.CLOCKWISE_90)));
                ...
                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get1x2SideEntrance(this.random, staircase), blockPos7, rotation.getRotated(Rotation.CLOCKWISE_90), Mirror.FRONT_BACK));
                ...
                blockPos8 = blockPos8.relative(rotation.rotate(Direction.SOUTH), 6);
                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get1x2SideEntrance(this.random, staircase), blockPos8, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90)));
                ...
                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get1x2FrontEntrance(this.random, staircase), blockPos9, rotation));
                ...
                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get1x2FrontEntrance(this.random, staircase), blockPos10, rotation.getRotated(Rotation.CLOCKWISE_180)));
                ...
                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get1x2FrontEntrance(this.random, staircase), blockPos11, rotation.getRotated(Rotation.CLOCKWISE_90)));
                ...
                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get1x2FrontEntrance(this.random, staircase), blockPos12, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90)));
                ...
                pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get1x2Secret(this.random), blockPos13, rotation.getRotated(Rotation.CLOCKWISE_90)));
        ...
        private void addRoom2x2(List<WoodlandMansionPieces.WoodlandMansionPiece> pieces, BlockPos pos, Rotation rotation, Direction connectedRoomDirection, Direction entranceDirection, WoodlandMansionPieces.FloorRoomCollection pool) {
            int i = 0;
            int j = 0;
        ...
        private void addRoom2x2Secret(List<WoodlandMansionPieces.WoodlandMansionPiece> pieces, BlockPos pos, Rotation rotation, WoodlandMansionPieces.FloorRoomCollection pool) {
            BlockPos blockPos = pos.relative(rotation.rotate(Direction.EAST), 1);
            pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, pool.get2x2Secret(this.random), blockPos, rotation, Mirror.NONE));
        }
    }
    ...
    public static class WoodlandMansionPiece extends TemplateStructurePiece {
        ...
        public WoodlandMansionPiece(StructureTemplateManager manager, CompoundTag nbt) {
            super(StructurePieceType.WOODLAND_MANSION_PIECE, nbt, manager, (id) -> {
