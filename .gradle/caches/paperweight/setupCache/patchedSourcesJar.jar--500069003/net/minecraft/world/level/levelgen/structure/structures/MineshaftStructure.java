...
public class MineshaftStructure extends Structure {
    ...
    private int generatePiecesAndAdjust(StructurePiecesBuilder collector, Structure.GenerationContext generationContext) {
    ...
    public static enum Type implements StringRepresentable {
        ...
        public static MineshaftStructure.Type byId(int index) {
