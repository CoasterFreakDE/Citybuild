...
public class ScatteredOreFeature extends Feature<OreConfiguration> {
    ...
    private void offsetTargetPos(BlockPos.MutableBlockPos mutable, RandomSource randomSource, BlockPos origin, int spread) {
        int i = this.getRandomPlacementInOneAxisRelativeToOrigin(randomSource, spread);
        int j = this.getRandomPlacementInOneAxisRelativeToOrigin(randomSource, spread);
        int k = this.getRandomPlacementInOneAxisRelativeToOrigin(randomSource, spread);
