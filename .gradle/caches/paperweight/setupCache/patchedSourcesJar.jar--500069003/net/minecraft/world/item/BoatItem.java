    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player user, InteractionHand hand) {
        ...
        if (movingobjectpositionblock.getType() == HitResult.Type.MISS) {
            ...
            if (movingobjectpositionblock.getType() == HitResult.Type.BLOCK) {
                ...
                org.bukkit.event.player.PlayerInteractEvent event = org.bukkit.craftbukkit.v1_19_R1.event.CraftEventFactory.callPlayerInteractEvent(user, org.bukkit.event.block.Action.RIGHT_CLICK_BLOCK, movingobjectpositionblock.getBlockPos(), movingobjectpositionblock.getDirection(), itemstack, hand);
                ...
                if (!world.noCollision(entityboat, entityboat.getBoundingBox())) {
                    ...
                    if (!world.isClientSide) {
                        // CraftBukkit start
                        if (org.bukkit.craftbukkit.v1_19_R1.event.CraftEventFactory.callEntityPlaceEvent(world, movingobjectpositionblock.getBlockPos(), movingobjectpositionblock.getDirection(), user, entityboat, hand).isCancelled()) {
                            return InteractionResultHolder.fail(itemstack);
                        }
