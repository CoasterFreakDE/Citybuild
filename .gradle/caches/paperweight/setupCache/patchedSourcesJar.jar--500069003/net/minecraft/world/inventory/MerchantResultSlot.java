...
public class MerchantResultSlot extends Slot {
    ...
    public void onTake(Player player, ItemStack stack) {
        ...
        if (merchantOffer != null && player instanceof net.minecraft.server.level.ServerPlayer serverPlayer) {
            ...
            } else if (this.merchant instanceof org.bukkit.craftbukkit.v1_19_R1.inventory.CraftMerchantCustom.MinecraftMerchant) {
            ...
            if (event != null) {
                ...
                merchantOffer = org.bukkit.craftbukkit.v1_19_R1.inventory.CraftMerchantRecipe.fromBukkit(event.getTrade()).toMinecraft();
            }
        }
        this.checkTakeAchievements(stack);
        // Paper end
