...
public class FoodData {
    ...
    public void eat(Item item, ItemStack stack) {
        if (item.isEdible()) {
            ...
            org.bukkit.event.entity.FoodLevelChangeEvent event = org.bukkit.craftbukkit.v1_19_R1.event.CraftEventFactory.callFoodLevelChangeEvent(entityhuman, foodinfo.getNutrition() + oldFoodLevel, stack);
    ...
    public void tick(Player player) {
        ...
        if (this.exhaustionLevel > 4.0F) {
            ...
            if (this.saturationLevel > 0.0F) {
                ...
                // CraftBukkit start
                org.bukkit.event.entity.FoodLevelChangeEvent event = org.bukkit.craftbukkit.v1_19_R1.event.CraftEventFactory.callFoodLevelChangeEvent(player, Math.max(this.foodLevel - 1, 0));
