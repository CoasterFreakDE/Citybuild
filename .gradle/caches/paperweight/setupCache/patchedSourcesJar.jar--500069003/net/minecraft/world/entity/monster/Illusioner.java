...
public class Illusioner extends SpellcasterIllager implements RangedAttackMob {
    ...
    public void performRangedAttack(LivingEntity target, float pullProgress) {
        ...
        // Paper start
        org.bukkit.event.entity.EntityShootBowEvent event = org.bukkit.craftbukkit.v1_19_R1.event.CraftEventFactory.callEntityShootBowEvent(this, this.getMainHandItem(), entityarrow.getPickupItem(), entityarrow, target.getUsedItemHand(), 0.8F, true);
