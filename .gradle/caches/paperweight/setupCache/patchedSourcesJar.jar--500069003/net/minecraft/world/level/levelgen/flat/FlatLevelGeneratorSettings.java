...
public class FlatLevelGeneratorSettings {
    ...
    private FlatLevelGeneratorSettings(Registry<Biome> biomeRegistry, Optional<HolderSet<StructureSet>> structureOverrides, List<FlatLayerInfo> layers, boolean hasLakes, boolean hasFeatures, Optional<Holder<Biome>> biome) {
    ...
    public FlatLevelGeneratorSettings(Optional<HolderSet<StructureSet>> structureOverrides, Registry<Biome> biomeRegistry) {
    ...
    public FlatLevelGeneratorSettings withLayers(List<FlatLayerInfo> layers, Optional<HolderSet<StructureSet>> structureOverrides) {
        FlatLevelGeneratorSettings flatLevelGeneratorSettings = new FlatLevelGeneratorSettings(structureOverrides, this.biomes);
    ...
    public static FlatLevelGeneratorSettings getDefault(Registry<Biome> biomeRegistry, Registry<StructureSet> structureSetRegistry) {
        HolderSet<StructureSet> holderSet = HolderSet.direct(structureSetRegistry.getHolderOrThrow(BuiltinStructureSets.STRONGHOLDS), structureSetRegistry.getHolderOrThrow(BuiltinStructureSets.VILLAGES));
        FlatLevelGeneratorSettings flatLevelGeneratorSettings = new FlatLevelGeneratorSettings(Optional.of(holderSet), biomeRegistry);
        flatLevelGeneratorSettings.biome = biomeRegistry.getOrCreateHolderOrThrow(Biomes.PLAINS);
