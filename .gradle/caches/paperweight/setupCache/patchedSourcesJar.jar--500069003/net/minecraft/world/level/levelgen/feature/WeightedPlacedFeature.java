...
public class WeightedPlacedFeature {
    ...
    public boolean place(WorldGenLevel world, ChunkGenerator chunkGenerator, RandomSource randomSource, BlockPos pos) {
        return this.feature.value().place(world, chunkGenerator, randomSource, pos);
    }
}
