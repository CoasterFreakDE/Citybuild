...
public record ProfilePublicKey(ProfilePublicKey.Data data) {
    ...
    public static ProfilePublicKey createValidated(SignatureValidator servicesSignatureVerifier, UUID playerUuid, ProfilePublicKey.Data publicKeyData, Duration duration) throws ProfilePublicKey.ValidationException {
        if (publicKeyData.hasExpired(duration)) {
