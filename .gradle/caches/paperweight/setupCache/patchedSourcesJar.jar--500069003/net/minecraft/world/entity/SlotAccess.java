...
public interface SlotAccess {
    ...
    static SlotAccess forContainer(final Container inventory, final int index, final Predicate<ItemStack> stackFilter) {
    ...
    static SlotAccess forEquipmentSlot(final LivingEntity entity, final EquipmentSlot slot, final Predicate<ItemStack> filter) {
        return new SlotAccess() {
            @Override
            public ItemStack get() {
