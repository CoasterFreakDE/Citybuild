...
public class ModelProvider implements DataProvider {
    ...
    private <T> void saveCollection(CachedOutput cache, Map<T, ? extends Supplier<JsonElement>> map, Function<T, Path> function) {
        map.forEach((object, supplier) -> {
            Path path = function.apply(object);

            try {
                DataProvider.saveStable(cache, supplier.get(), path);
