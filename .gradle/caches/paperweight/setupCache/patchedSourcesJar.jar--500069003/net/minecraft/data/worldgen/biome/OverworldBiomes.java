...
public class OverworldBiomes {
    ...
    private static Biome biome(Biome.Precipitation precipitation, float temperature, float downfall, MobSpawnSettings.Builder spawnSettings, BiomeGenerationSettings.Builder generationSettings, @Nullable Music music) {
        return biome(precipitation, temperature, downfall, 4159204, 329011, spawnSettings, generationSettings, music);
    }

    private static Biome biome(Biome.Precipitation precipitation, float temperature, float downfall, int waterColor, int waterFogColor, MobSpawnSettings.Builder spawnSettings, BiomeGenerationSettings.Builder generationSettings, @Nullable Music music) {
    ...
    public static Biome oldGrowthTaiga(boolean spruce) {
        ...
        return biome(Biome.Precipitation.RAIN, spruce ? 0.25F : 0.3F, 0.8F, builder, builder2, music);
    }
    ...
    private static Biome baseJungle(float depth, boolean bamboo, boolean sparse, boolean unmodified, MobSpawnSettings.Builder spawnSettings) {
        ...
        return biome(Biome.Precipitation.RAIN, 0.95F, depth, spawnSettings, builder, music);
    }
    ...
    public static Biome plains(boolean sunflower, boolean snowy, boolean iceSpikes) {
        ...
        return biome(snowy ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN, f, snowy ? 0.5F : 0.4F, builder, builder2, NORMAL_MUSIC);
    }
    ...
    private static Biome baseOcean(MobSpawnSettings.Builder spawnSettings, int waterColor, int waterFogColor, BiomeGenerationSettings.Builder builder) {
        return biome(Biome.Precipitation.RAIN, 0.5F, 0.5F, waterColor, waterFogColor, spawnSettings, builder, NORMAL_MUSIC);
    }
    ...
    public static Biome taiga(boolean cold) {
        ...
        return biome(cold ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN, f, cold ? 0.4F : 0.8F, cold ? 4020182 : 4159204, 329011, builder, builder2, NORMAL_MUSIC);
    }
    ...
    public static Biome river(boolean frozen) {
        ...
        return biome(frozen ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN, f, 0.5F, frozen ? 3750089 : 4159204, 329011, builder, builder2, NORMAL_MUSIC);
    }
    ...
    public static Biome beach(boolean snowy, boolean stony) {
        ...
        return biome(snowy ? Biome.Precipitation.SNOW : Biome.Precipitation.RAIN, f, bl ? 0.4F : 0.3F, snowy ? 4020182 : 4159204, 329011, builder, builder2, NORMAL_MUSIC);
    }
