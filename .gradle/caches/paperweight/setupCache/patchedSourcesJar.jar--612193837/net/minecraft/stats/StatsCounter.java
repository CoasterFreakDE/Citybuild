...
public class StatsCounter {
    ...
    public void increment(Player player, Stat<?> stat, int value) {
        ...
        org.bukkit.event.Cancellable cancellable = org.bukkit.craftbukkit.v1_19_R1.event.CraftEventFactory.handleStatisticsIncrease(player, stat, this.getValue(stat), j);
