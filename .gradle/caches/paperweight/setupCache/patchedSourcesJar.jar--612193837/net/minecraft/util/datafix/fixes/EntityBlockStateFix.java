...
public class EntityBlockStateFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        Function<Typed<?>, Typed<?>> function = (minecart) -> {
            return this.updateBlockToBlockState(minecart, "DisplayTile", "DisplayData", "DisplayState");
        };
        Function<Typed<?>, Typed<?>> function2 = (arrow) -> {
            return this.updateBlockToBlockState(arrow, "inTile", "inData", "inBlockState");
        };
        ...
        Function<Typed<?>, Typed<?>> function3 = (projectile) -> {
            return projectile.update(type.finder(), DSL.remainderType(), Pair::getSecond);
        };
        return this.fixTypeEverywhereTyped("EntityBlockStateFix", schema.getType(References.ENTITY), schema2.getType(References.ENTITY), (entity) -> {
            entity = this.updateEntity(entity, "minecraft:falling_block", this::updateFallingBlock);
            entity = this.updateEntity(entity, "minecraft:enderman", (enderman) -> {
                return this.updateBlockToBlockState(enderman, "carried", "carriedData", "carriedBlockState");
            });
    ...
    private Typed<?> updateFallingBlock(Typed<?> fallingBlock) {
        ...
        return fallingBlock.update(type.finder(), type2, (state) -> {
            int i = state.map((pair) -> {
                return pair.getSecond().map((id) -> {
                    return id;
