...
public class HttpUtil {
    ...
    public static CompletableFuture<?> downloadTo(File file, URL url, Map<String, String> headers, int maxFileSize, @Nullable ProgressListener progressListener, Proxy proxy) {
