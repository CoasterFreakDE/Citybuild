...
public class SynchedEntityData {
    ...
    private static <T> SynchedEntityData.DataItem<T> genericHelper(FriendlyByteBuf buf, int id, EntityDataSerializer<T> handler) {
        return new SynchedEntityData.DataItem<>(handler.createAccessor(id), handler.read(buf));
    }
