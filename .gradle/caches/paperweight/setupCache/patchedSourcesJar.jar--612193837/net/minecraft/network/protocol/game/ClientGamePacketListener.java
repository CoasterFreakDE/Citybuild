...
public interface ClientGamePacketListener extends PacketListener {
    ...
    void handlePlayerChatHeader(ClientboundPlayerChatHeaderPacket packet);

    void handleChatPreview(ClientboundChatPreviewPacket packet);

    void handleSetDisplayChatPreview(ClientboundSetDisplayChatPreviewPacket packet);
