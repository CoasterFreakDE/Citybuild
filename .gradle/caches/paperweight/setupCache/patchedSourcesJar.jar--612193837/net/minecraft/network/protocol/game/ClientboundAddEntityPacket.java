...
public class ClientboundAddEntityPacket implements Packet<ClientGamePacketListener> {
    ...
    public ClientboundAddEntityPacket(LivingEntity entity) {
        this(entity, 0);
    }

    public ClientboundAddEntityPacket(LivingEntity entity, int entityTypeId) {
        this(entity.getId(), entity.getUUID(), entity.getX(), entity.getY(), entity.getZ(), entity.getXRot(), entity.getYRot(), entity.getType(), entityTypeId, entity.getDeltaMovement(), (double)entity.yHeadRot);
    }
    ...
    public ClientboundAddEntityPacket(Entity entity, int entityData) {
        this(entity.getId(), entity.getUUID(), entity.getX(), entity.getY(), entity.getZ(), entity.getXRot(), entity.getYRot(), entity.getType(), entityData, entity.getDeltaMovement(), 0.0D);
    }

    public ClientboundAddEntityPacket(Entity entity, int entityTypeId, BlockPos pos) {
        this(entity.getId(), entity.getUUID(), (double)pos.getX(), (double)pos.getY(), (double)pos.getZ(), entity.getXRot(), entity.getYRot(), entity.getType(), entityTypeId, entity.getDeltaMovement(), 0.0D);
    }

    public ClientboundAddEntityPacket(int id, UUID uuid, double x, double y, double z, float pitch, float yaw, EntityType<?> entityTypeId, int entityData, Vec3 velocity, double headYaw) {
        this.id = id;
        this.uuid = uuid;
        this.x = x;
        this.y = y;
