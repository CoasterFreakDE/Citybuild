...
public class Structures {
    ...
    public static final Holder<Structure> ANCIENT_CITY = register(BuiltinStructures.ANCIENT_CITY, new JigsawStructure(structure(BiomeTags.HAS_ANCIENT_CITY, Arrays.stream(MobCategory.values()).collect(Collectors.toMap((mobCategory) -> {
        return mobCategory;
    }, (mobCategory) -> {
