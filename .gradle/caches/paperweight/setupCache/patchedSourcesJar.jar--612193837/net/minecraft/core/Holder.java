...
public interface Holder<T> {
    ...
    public static class Reference<T> implements Holder<T> {
        ...
        /** @deprecated */
        @Deprecated
        public static <T> Holder.Reference<T> createIntrusive(Registry<T> registry, @Nullable T value) {
            return new Holder.Reference<>(Holder.Reference.Type.INTRUSIVE, registry, (ResourceKey<T>)null, value);
        }
