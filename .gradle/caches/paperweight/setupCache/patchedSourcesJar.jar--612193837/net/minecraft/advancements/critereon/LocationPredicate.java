...
public class LocationPredicate {
    ...
    public LocationPredicate(MinMaxBounds.Doubles x, MinMaxBounds.Doubles y, MinMaxBounds.Doubles z, @Nullable ResourceKey<Biome> biome, @Nullable ResourceKey<Structure> feature, @Nullable ResourceKey<Level> dimension, @Nullable Boolean smokey, LightPredicate light, BlockPredicate block, FluidPredicate fluid) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.biome = biome;
    ...
    public static LocationPredicate inBiome(ResourceKey<Biome> biome) {
        return new LocationPredicate(MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, biome, (ResourceKey<Structure>)null, (ResourceKey<Level>)null, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
    }

    public static LocationPredicate inDimension(ResourceKey<Level> dimension) {
        return new LocationPredicate(MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, MinMaxBounds.Doubles.ANY, (ResourceKey<Biome>)null, (ResourceKey<Structure>)null, dimension, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
    }

    public static LocationPredicate inStructure(ResourceKey<Structure> feature) {
    ...
    public static LocationPredicate atYLocation(MinMaxBounds.Doubles y) {
        return new LocationPredicate(MinMaxBounds.Doubles.ANY, y, MinMaxBounds.Doubles.ANY, (ResourceKey<Biome>)null, (ResourceKey<Structure>)null, (ResourceKey<Level>)null, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
    }
    ...
    public boolean matches(ServerLevel world, double x, double y, double z) {
        if (!this.x.matches(x)) {
            ...
            if (this.biome == null || bl && world.getBiome(blockPos).is(this.biome)) {
                if (this.structure == null || bl && world.structureManager().getStructureWithPieceAt(blockPos, this.structure).isValid()) {
    ...
    public JsonElement serializeToJson() {
        if (this == ANY) {
            ...
            if (this.dimension != null) {
                Level.RESOURCE_KEY_CODEC.encodeStart(JsonOps.INSTANCE, this.dimension).resultOrPartial(LOGGER::error).ifPresent((json) -> {
    ...
    public static LocationPredicate fromJson(@Nullable JsonElement json) {
        if (json != null && !json.isJsonNull()) {
            ...
            ResourceKey<Structure> resourceKey2 = jsonObject.has("structure") ? ResourceLocation.CODEC.parse(JsonOps.INSTANCE, jsonObject.get("structure")).resultOrPartial(LOGGER::error).map((resourceLocation) -> {
    ...
    public static class Builder {
        ...
        public LocationPredicate.Builder setStructure(@Nullable ResourceKey<Structure> feature) {
            this.structure = feature;
            return this;
        }
