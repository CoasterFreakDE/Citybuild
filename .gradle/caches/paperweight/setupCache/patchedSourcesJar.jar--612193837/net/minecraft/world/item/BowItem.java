            ...
            if (!itemstack1.isEmpty() || flag) {
                ...
                if ((double) f >= 0.1D) {
                    ...
                    if (!world.isClientSide) {
                        ...
                        // CraftBukkit start
                        org.bukkit.event.entity.EntityShootBowEvent event = org.bukkit.craftbukkit.v1_19_R1.event.CraftEventFactory.callEntityShootBowEvent(entityhuman, stack, itemstack1, entityarrow, entityhuman.getUsedItemHand(), f, !flag1);
