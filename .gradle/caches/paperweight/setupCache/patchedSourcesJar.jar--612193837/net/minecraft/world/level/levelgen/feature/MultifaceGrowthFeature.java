...
public class MultifaceGrowthFeature extends Feature<MultifaceGrowthConfiguration> {
    ...
    public static boolean placeGrowthIfPossible(WorldGenLevel world, BlockPos pos, BlockState state, MultifaceGrowthConfiguration config, RandomSource random, List<Direction> directions) {
