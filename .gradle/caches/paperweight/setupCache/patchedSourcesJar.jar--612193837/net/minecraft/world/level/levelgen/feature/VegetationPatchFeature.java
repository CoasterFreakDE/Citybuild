...
public class VegetationPatchFeature extends Feature<VegetationPatchConfiguration> {
    ...
    protected boolean placeGround(WorldGenLevel world, VegetationPatchConfiguration config, Predicate<BlockState> replaceable, RandomSource randomSource, BlockPos.MutableBlockPos pos, int depth) {
        for(int i = 0; i < depth; ++i) {
            BlockState blockState = config.groundState.getState(randomSource, pos);
