...
public class LavaSubmergedBlockProcessor extends StructureProcessor {
    ...
    public StructureTemplate.StructureBlockInfo processBlock(LevelReader world, BlockPos pos, BlockPos pivot, StructureTemplate.StructureBlockInfo originalBlockInfo, StructureTemplate.StructureBlockInfo currentBlockInfo, StructurePlaceSettings data) {
        ...
        return bl && !Block.isShapeFullBlock(currentBlockInfo.state.getShape(world, blockPos)) ? new StructureTemplate.StructureBlockInfo(blockPos, Blocks.LAVA.defaultBlockState(), currentBlockInfo.nbt) : currentBlockInfo;
    }
