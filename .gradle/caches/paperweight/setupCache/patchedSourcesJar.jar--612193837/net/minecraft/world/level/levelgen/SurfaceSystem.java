...
public class SurfaceSystem {
    ...
    public SurfaceSystem(RandomState noiseConfig, BlockState defaultState, int seaLevel, PositionalRandomFactory randomDeriver) {
        ...
        this.clayBands = generateBands(randomDeriver.fromHashOf(new ResourceLocation("clay_bands")));
    ...
    public void buildSurface(RandomState noiseConfig, BiomeManager biomeAccess, Registry<Biome> biomeRegistry, boolean useLegacyRandom, WorldGenerationContext heightContext, final ChunkAccess chunk, NoiseChunk chunkNoiseSampler, SurfaceRules.RuleSource materialRule) {
        ...
        SurfaceRules.Context context = new SurfaceRules.Context(this, noiseConfig, chunk, chunkNoiseSampler, biomeAccess::getBiome, biomeRegistry, heightContext);
    ...
    protected int getSurfaceDepth(int i, int j) {
        ...
        return (int)(d * 2.75D + 3.0D + this.noiseRandom.at(i, 0, j).nextDouble() * 0.25D);
    }
    ...
    public Optional<BlockState> topMaterial(SurfaceRules.RuleSource rule, CarvingContext context, Function<BlockPos, Holder<Biome>> posToBiome, ChunkAccess chunk, NoiseChunk chunkNoiseSampler, BlockPos pos, boolean hasFluid) {
        SurfaceRules.Context context2 = new SurfaceRules.Context(this, context.randomState(), chunk, chunkNoiseSampler, posToBiome, context.registryAccess().registryOrThrow(Registry.BIOME_REGISTRY), context);
