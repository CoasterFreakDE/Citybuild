...
public class CarverConfiguration extends ProbabilityFeatureConfiguration {
    ...
    public CarverConfiguration(float probability, HeightProvider y, FloatProvider yScale, VerticalAnchor lavaLevel, CarverDebugSettings debugConfig, HolderSet<Block> replaceable) {
        super(probability);
        this.y = y;
        this.yScale = yScale;
