...
public class HugeFungusFeature extends Feature<HugeFungusConfiguration> {
    ...
    private void placeStem(LevelAccessor world, RandomSource random, HugeFungusConfiguration config, BlockPos pos, int stemHeight, boolean thickStem) {
    ...
    private void placeHat(LevelAccessor world, RandomSource random, HugeFungusConfiguration config, BlockPos pos, int hatHeight, boolean thickStem) {
        BlockPos.MutableBlockPos mutableBlockPos = new BlockPos.MutableBlockPos();
