...
public class LevelStorageSource {
            ...
            try {
                ...
                if (tag instanceof CompoundTag compoundTag) {
                    ...
                    if (j == 19132 || j == 19133) {
                        ...
                        return new LevelSummary(levelSettings, levelVersion, levelSave.directoryName(), bl2, locked, path2);
                    }
                } else {
    ...
    public class LevelStorageAccess implements AutoCloseable {
        ...
        public WorldData getDataTag(DynamicOps<Tag> ops, DataPackConfig dataPackSettings, Lifecycle lifecycle) {
            this.checkLock();
            return LevelStorageSource.this.readLevelData(this.levelDirectory, LevelStorageSource.getLevelData(ops, dataPackSettings, lifecycle));
        }
