                    ...
                    for (int j = 0; j <= 10 && j >= -10; j = (j <= 0 ? 1 : 0) - j) {
                        for (int k = 0; k <= 10 && k >= -10; k = (k <= 0 ? 1 : 0) - k) {
                            ...
                            if (block instanceof InfestedBlock) {
                                ...
                                org.bukkit.event.entity.EntityChangeBlockEvent event = org.bukkit.craftbukkit.v1_19_R1.event.CraftEventFactory.callEntityChangeBlockEvent(this.silverfish, blockposition1, afterState);
