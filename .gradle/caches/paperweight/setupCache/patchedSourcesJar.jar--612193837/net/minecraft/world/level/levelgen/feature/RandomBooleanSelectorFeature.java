...
public class RandomBooleanSelectorFeature extends Feature<RandomBooleanFeatureConfiguration> {
    ...
    public boolean place(FeaturePlaceContext<RandomBooleanFeatureConfiguration> context) {
        ...
        return ((PlacedFeature)(bl ? randomBooleanFeatureConfiguration.featureTrue : randomBooleanFeatureConfiguration.featureFalse).value()).place(worldGenLevel, chunkGenerator, randomSource, blockPos);
    }
}
