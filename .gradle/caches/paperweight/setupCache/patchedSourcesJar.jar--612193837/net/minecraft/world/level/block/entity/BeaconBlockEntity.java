...
public class BeaconBlockEntity extends BlockEntity implements MenuProvider {
    ...
    public static void tick(Level world, BlockPos pos, BlockState state, BeaconBlockEntity blockEntity) {
        ...
        if (i1 <= 0 && blockEntity.levels > 0) {
            org.bukkit.block.Block block = org.bukkit.craftbukkit.v1_19_R1.block.CraftBlock.at(world, pos);
    ...
    public void setRemoved() {
        ...
        org.bukkit.block.Block block = org.bukkit.craftbukkit.v1_19_R1.block.CraftBlock.at(level, worldPosition);
        new io.papermc.paper.event.block.BeaconDeactivatedEvent(block).callEvent();
        // Paper end
