...
public class WoodlandMansionStructure extends Structure {
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        return blockPos.getY() < 60 ? Optional.empty() : Optional.of(new Structure.GenerationStub(blockPos, (collector) -> {
            this.generatePieces(collector, context, blockPos, rotation);
        }));
    }
