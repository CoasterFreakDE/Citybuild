                ...
                if (combatEntry.getSource() != DamageSource.FALL && combatEntry.getSource() != DamageSource.OUT_OF_WORLD) {
                    if (component2 != null && !component2.equals(component)) {
                        ...
                        if (!itemStack.isEmpty() && itemStack.hasCustomHoverName()) {
                            component4 = Component.translatable("death.fell.assist.item", this.mob.getDisplayName(), component2, itemStack.getDisplayName());
                        } else {
                            component4 = Component.translatable("death.fell.assist", this.mob.getDisplayName(), component2);
                        }
                        ...
                        if (!itemStack2.isEmpty() && itemStack2.hasCustomHoverName()) {
                            component4 = Component.translatable("death.fell.finish.item", this.mob.getDisplayName(), component, itemStack2.getDisplayName());
                        } else {
                            component4 = Component.translatable("death.fell.finish", this.mob.getDisplayName(), component);
                        }
                    } else {
                        component4 = Component.translatable("death.fell.killer", this.mob.getDisplayName());
                    }
                } else {
                    component4 = Component.translatable("death.fell.accident." + this.getFallLocation(combatEntry), this.mob.getDisplayName());
                }
            } else {
