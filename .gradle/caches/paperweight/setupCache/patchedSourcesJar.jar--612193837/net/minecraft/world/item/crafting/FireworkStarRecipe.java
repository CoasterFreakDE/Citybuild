...
public class FireworkStarRecipe extends CustomRecipe {
    ...
    private static final Map<Item, FireworkRocketItem.Shape> SHAPE_BY_ITEM = Util.make(Maps.newHashMap(), (typeModifiers) -> {
        typeModifiers.put(Items.FIRE_CHARGE, FireworkRocketItem.Shape.LARGE_BALL);
        typeModifiers.put(Items.FEATHER, FireworkRocketItem.Shape.BURST);
        typeModifiers.put(Items.GOLD_NUGGET, FireworkRocketItem.Shape.STAR);
        typeModifiers.put(Items.SKELETON_SKULL, FireworkRocketItem.Shape.CREEPER);
        typeModifiers.put(Items.WITHER_SKELETON_SKULL, FireworkRocketItem.Shape.CREEPER);
        typeModifiers.put(Items.CREEPER_HEAD, FireworkRocketItem.Shape.CREEPER);
        typeModifiers.put(Items.PLAYER_HEAD, FireworkRocketItem.Shape.CREEPER);
        typeModifiers.put(Items.DRAGON_HEAD, FireworkRocketItem.Shape.CREEPER);
        typeModifiers.put(Items.ZOMBIE_HEAD, FireworkRocketItem.Shape.CREEPER);
    });
