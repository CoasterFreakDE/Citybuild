    ...
    protected void onHitBlock(BlockHitResult blockHitResult) {
        ...
        if (!this.level.isClientSide) {
            ...
            if (isIncendiary) { // CraftBukkit
                ...
                if (this.level.isEmptyBlock(blockposition) && !org.bukkit.craftbukkit.v1_19_R1.event.CraftEventFactory.callBlockIgniteEvent(level, blockposition, this).isCancelled()) { // CraftBukkit
